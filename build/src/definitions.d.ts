...
export interface strEmbryonicTransform {
    replaceAllAsync(str: string, pattern: RegExp, replacer: TSReplacerAllAsync, mode: PromiseExecutionMode): Promise<string>;
    replaceAsync(input: string, regex: string | RegExp, replacer: string | TSPromiseMatch): Promise<string>;
}
